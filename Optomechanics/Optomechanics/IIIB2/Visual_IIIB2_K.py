...
lst_range = np.array([[68856.0, 78508.0], [431512.0, 492000.0], [1208247.0, 1377614.0], [2367683.0, 2699573.0], [3913949.0, 4462588.0]])/1000
a = 0.7
...
for range in lst_range:
    axs[0].hlines(-65, range[0], range[1], 'k')
...
for range in lst_range:
    axs[1].hlines(-65, range[0], range[1], 'k')
...
for range in lst_range:
    axs[2].hlines(-65, range[0], range[1], 'k')
